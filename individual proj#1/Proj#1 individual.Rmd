...
trendTweets <- searchTwitter("OnePiece -filter:retweets", n=10000, lang="en", since="2022-11-22", until="2022-11-29",
...
\hfill\break
```{R}
tweetsDF0$tweetSource = sapply(tweetsDF0$statusSource,Sourcedplotss)
